...
client.onmessage = async (e) => {
  try {
    ...
    console.log(`[${NL_EXTID}] Received message:`, message);
    
    const { event, data } = message;
    console.log(`[${NL_EXTID}] Processing event: ${event}`);
    ...
    console.log(`[${NL_EXTID}] Sending response for ${event}:`, response);
    sendToApp(`${event}Response`, response);
  } catch (error) {
    console.error(`[${NL_EXTID}] Message processing error:`, error.message);
    console.error(`[${NL_EXTID}] Stack:`, error.stack);
